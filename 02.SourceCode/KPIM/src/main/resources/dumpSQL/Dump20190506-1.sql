...
--
-- Table structure for table `type_of_work_copy1`
--

DROP TABLE IF EXISTS `type_of_work_copy1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `type_of_work_copy1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type_name` varchar(100) NOT NULL,
  `description` varchar(500) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `type_of_work_copy1`
--

LOCK TABLES `type_of_work_copy1` WRITE;
/*!40000 ALTER TABLE `type_of_work_copy1` DISABLE KEYS */;
/*!40000 ALTER TABLE `type_of_work_copy1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-06 15:11:48
