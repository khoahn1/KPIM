...
INSERT INTO `components` VALUES ('1','Project Management','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin'),('2','Project Meeting','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin'),('3','Project Record','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin'),('4','Training Record','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin'),('5','IRC','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin'),('6','FAIMS_WD','PJ00000002',1,'2019-05-06 09:31:52','2019-05-06 09:31:52','admin','admin');
...
INSERT INTO `departments` VALUES ('1','SS2','SS2','PD00000001',1,NULL,'2019-05-14 13:26:51',NULL,NULL,NULL);
...
INSERT INTO `parent_departments` VALUES ('PD00000001','FSG','FSG','1',NULL,1,NULL,'2019-05-14 13:27:10',NULL,NULL),('PD00000002','FDN','FDN','1','123',1,'2019-05-14 13:28:03','2019-05-14 13:56:03',NULL,NULL);
...
INSERT INTO `products` VALUES ('1','Meeting','5',6,0,1,NULL,NULL,NULL,NULL),('2','YOKOTENKAI','6',1,0,1,NULL,NULL,NULL,NULL),('3','PH0020142-0107','6',1,0,1,NULL,NULL,NULL,NULL),('4','CR','6',1,0,1,NULL,NULL,NULL,NULL),('5','FixBugIT','6',1,0,1,NULL,NULL,NULL,NULL),('6','CR','5',1,0,1,NULL,NULL,NULL,NULL),('7','Training_JP','4',6,0,1,NULL,NULL,NULL,NULL),('8','Training_Technical','4',6,0,1,NULL,NULL,NULL,NULL),('9','Management','1',6,0,1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `project_user` (
  ...
  KEY `fk_project_user_projects1_idx` (`project_id`),
  KEY `fk_project_user_users1_idx` (`user_id`),
  CONSTRAINT `project_user_projects` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `project_user_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_user` VALUES (1,'US00000002','PJ00000002',NULL,NULL,NULL,NULL);
...
INSERT INTO `projects` VALUES ('PJ00000002','kin3','kinyu3','1',NULL,1,'2019-05-09 08:24:36','2019-05-09 08:24:36','admin',NULL);
...
-- Dump completed on 2019-05-15 15:57:07
