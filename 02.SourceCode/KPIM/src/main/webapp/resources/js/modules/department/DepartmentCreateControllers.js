...
myapp.controller('DepartmentCreateController', function($rootScope, $scope, $state, Session, USER_ROLES, $localStorage,
    ...
    $scope.createDepartment = function () {
        ...
        DepartmentCreateService.create($scope.department)
            .then(function success(response) {
            	$uibModalInstance.close();
            	$rootScope.$broadcast("reload-department", { title: "Create Department", message: response.data, notificationType: "success" });
