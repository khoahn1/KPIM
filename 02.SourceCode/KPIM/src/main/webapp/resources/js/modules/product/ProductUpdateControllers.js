...
myapp.controller('ProductUpdateController', function($rootScope, $scope, $state, Session, USER_ROLES, $localStorage,
				$sessionStorage, $ngConfirm, $routeParams, $log, $uibModalInstance, ngTableParams, ProductUpdateService) {
	
	$scope.initForm = function() {
		var productUpdateRequest = {
    		id : $localStorage.prevPageData.selectedProduct.id
    	};
		ProductUpdateService.init(productUpdateRequest).then(function success(response) {
    ...
    $scope.updateProduct = function () {
        ...
        ProductUpdateService.update($scope.productUpdateRequest)
            .then(function success(response) {
            	$uibModalInstance.close();
            	$rootScope.$broadcast("reload-product", { title: "Update product", message: response.data, notificationType: "success" });
