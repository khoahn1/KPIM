...
myapp.controller('UserImportController', function($rootScope, $scope, $state, Session, USER_ROLES, $localStorage,
    $sessionStorage, $ngConfirm, $routeParams, $log, $uibModalInstance, ngTableParams, UserImportService) {
    ...
    $scope.uploadFile = function() {
        ...
        UserImportService.upload(data).then(function success(response) {
        	var recordExport = $rootScope.allImportExportTask.find(x => x.id === "Users_DataImport_" + id_);
