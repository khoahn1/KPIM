...
myapp.controller('ProjectImportController', function($rootScope, $scope, $state, Session, USER_ROLES, $localStorage,
    $sessionStorage, $ngConfirm, $routeParams, $log, $uibModalInstance, ngTableParams, ProjectImportService) {
	...
	$scope.uploadFile = function () {
		...
		ProjectImportService.upload(data).then(function success(response) {
        	var recordExport = $rootScope.allImportExportTask.find(x => x.id === "Projects_DataImport_" + id_);
