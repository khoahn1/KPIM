myapp
    ...
    .controller('materialadminCtrl', function($rootScope, $localStorage, $timeout, $state, $scope, growlService){
    	
    	if (!$localStorage.isFirst) {
    		var importExportBoard = {
				allImportExportTask: [],
				showImportExportBoard: false,
				isExpImportExportBoard: false,
				isMinImportExportBoard: false
			}
			$localStorage.importExportBoard = importExportBoard;
    		$localStorage.isFirst = true;
		}
    	
    	$scope.minmaxImportExportBoard = function(){
    		$rootScope.isMinImportExportBoard = !$localStorage.importExportBoard.isMinImportExportBoard;
    		$localStorage.importExportBoard.isMinImportExportBoard = $rootScope.isMinImportExportBoard;
    		$rootScope.isExpImportExportBoard = $localStorage.importExportBoard.isExpImportExportBoard = false;
    	}
    	
    	$scope.expcompImportExportBoard = function(){
    		$rootScope.isExpImportExportBoard = !$localStorage.importExportBoard.isExpImportExportBoard;
    		$localStorage.importExportBoard.isExpImportExportBoard = $rootScope.isExpImportExportBoard;
    		$rootScope.isMinImportExportBoard = $localStorage.importExportBoard.isMinImportExportBoard = false;
    	}
    	
    	$scope.closeImportExportBoard= function(){
    		var importExportBoard = {
				allImportExportTask: [],
				showImportExportBoard: false,
				isExpImportExportBoard: false,
			...
			$localStorage.importExportBoard = importExportBoard;
    		$rootScope.allImportExportTask = [];
        	$rootScope.showImportExportBoard = false;
        	$rootScope.isMinImportExportBoard =  false;
        	$rootScope.isExpImportExportBoard =  false;
    	}
    ...
    .controller('profileCtrl', function(growlService){
        ...
        this.fullName = "KhoaHN";
        this.gender = "male";
        this.birthDay = "15/07/1992";
        this.martialStatus = "Single";
        this.mobileNumber = "0989842323";
        this.emailAddress = "khoahn.fpt.@gmail.com";
        this.twitter = "@khoa";
        this.twitterUrl = "twitter.com/khoa";
        this.skype = "khoahn.fpt";
        this.addressSuite = "Phước An";
        this.addressCity = "Daklak";
        this.addressCountry = "VietNam";
